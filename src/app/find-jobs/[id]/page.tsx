        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="space-y-8">
            <div className="space-y-6 text-center sm:text-left">
              ...
              <h1 className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white sm:text-6xl lg:text-7xl leading-[1.05]">
                {job.title}
              </h1>
            ...
            {/* Premium Data Action Bar */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-y border-slate-100 dark:border-[#1a1a1a] py-10">
              <DataCard 
          ...
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-12 pb-24">
                ...
                <section className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {job.tags.split(",").map((tag) => (
                      <Badge
                        key={tag}
                        className="rounded-2xl border-2 border-slate-100 bg-transparent px-6 py-3 text-sm font-bold text-slate-600 transition-all hover:border-primary hover:text-primary hover:bg-primary/5 dark:border-[#1a1a1a] dark:text-slate-300 dark:hover:border-primary"
                      >
                        {tag.trim()}
                      </Badge>
                    ))}
            ...
            <div className="lg:col-span-4">
              <div className="sticky top-12 space-y-6">
                <Card className="rounded-[3rem] border border-slate-100 bg-slate-50/30 p-2 dark:border-[#1a1a1a] dark:bg-[#121212]/50 backdrop-blur-xl">
                ...
                <div className="px-8 text-center space-y-2 opacity-40">
                   <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">
                    Ref ID: GENIUS-{job.id}
                  </p>
                </div>
              </div>
            </div>
...
function DataCard({ icon, label, value, subValue }: { icon: ReactNode; label: string; value: string; subValue: string }) {
  return (
    <div className="flex flex-col gap-4 p-6 rounded-[2.5rem] bg-slate-50/50 dark:bg-[#121212]/30 border border-transparent hover:border-primary/20 transition-all group">
